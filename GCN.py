...
# Here this class is very similar to the GCN class, but uses the GraphConv class instead of the GCNConv class.
...
if Conv_type == 'GCN':
    ...
    model = Graph(in_channels=nbr_features, hidden_channels=parameters[1], out_channels=nbr_classes, num_layers=parameters[2], dropout=parameters[3], nbr_classes=nbr_classes)
    optimizer = torch.optim.Adam(model.parameters(), lr=parameters[0])
